                  ...
                  <tr key={index} className="text-gray-700 dark:text-white">
                    ...
                    <td className="py-2 px-4 border-b">
                      <a
                        ...
                        target="_blank"
                        className="bg-blue-50 text-blue-400 px-4 py-1 rounded inline-flex gap-2 items-center hover:scale-105 active:scale-95 transition-all duration-300"
                      >
                    ...
                    <td className="py-2 px-4 border-b relative">
                      {applicant.status === "Pending" ? (
                        <div className="relative inline-block text-left group">
                          <button className="relative text-gray-500 action-button">
                            ...
                          </button>
                          <div className="z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block">
                            <button
                              ...
                              className="block w-full text-left py-2 px-4 text-green-500 hover:bg-gray-100"
                            >
                              Accept
                            </button>
                            <button
